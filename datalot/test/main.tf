...
#declare variables
variable "access_key" {
  default = "AKIA3YWQMZ2VJHSDWWYD"
}

variable "secret_key" {
  default = "cTFfeI6GoNwXYzAteoIYuF9+RXKoy3fdGM6Er+rz"
}
...
resource "aws_instance" "my_web_instance" {
  ...
  key_name               = "spark_qa" #make sure you have your_private_ket.pem file
  ...
  connection {
    ...
    private_key = file("~/.ssh/spark_qa.pem")
  }
}
